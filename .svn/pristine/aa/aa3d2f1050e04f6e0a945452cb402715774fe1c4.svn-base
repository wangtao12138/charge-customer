...
public interface IDeviceUseDetailedService extends BaseService<DeviceUseDetailed> {
    ...
    // 查询某个用户针对某个充电桩正在充电中记录
    DeviceUseDetailed queryChargingOrder(String customerGuid,String chargingPlieGuid);
    ...
    //首页统计商户本日数据
    DeviceUseDetailed queryDeviceUseDetailed(DeviceUseDetailed deviceUseDetailed);

    List<DeviceUseDetailed> queryDeviceUseDetailed(String customerGuid);
