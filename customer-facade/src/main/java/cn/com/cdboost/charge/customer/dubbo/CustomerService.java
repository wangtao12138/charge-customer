...
public interface CustomerService {
     ...
     * @param paramMap
     */
    void wxPayNotify(Map<String, String> paramMap);

    /**
     * 微信退款结果通知
     * @param paramMap
     */
    void refundResultNotify(Map<String, String> paramMap);
     ...
     * @return
     */
    AlipayChargeInfo alipayReCharge(AlipayRechargeVo rechargeVo);

    /**
     * 支付宝回调通知
     * @param param
     */
    void zfbPayNotify(ZfbPayNoticeParam param);

    /**
     * 前端用户取消支付
     * @param payFlag
     */
    void userCancelPay(String payFlag);
